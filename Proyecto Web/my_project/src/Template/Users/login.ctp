...
<div class="form">
  ...
  <div class="tab-content">
	 ...
	 <p class="forgot"><?= $this->Html->link(__('Forgot Password?'),['action'=>'forgotpassword'])?></p>
    
        <button class="button button-block" ><?php echo __('Log In') ?></button>
	
		<div class="btnlogin"><a href="" class="btn btn-block btn-social btn-facebook"><span class="fa fa-facebook"></span><?php echo __('Login with Facebook')?></a></div>
		<div class="btnlogin"><a href="" class="btn btn-block btn-social btn-google"><span class="fa fa-google"></span><?php echo __('Login with Google')?></a></div>
		<div class="btnlogin"><a href="" class="btn btn-block btn-social btn-twitter"><span class="fa fa-twitter"></span><?php echo __('Login with Twitter')?></a></div>
