...
class CarsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('license', false, __('enter license please'))
            ->add('license', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->scalar('maker')
            ->maxLength('maker', 30)
            ->requirePresence('maker', 'create', __('enter maker please'))
        ...
        $validator
            ...
            ->allowEmptyString('colour', false, __('enter colour please'));
